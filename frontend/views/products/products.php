...
<div class="row">
    <div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
        <div class="leftbar p-r-20 p-r-0-sm">
            ...
            <ul class="p-b-54">
                <li class="p-t-4">
                    <a href="<?= \yii\helpers\Url::to(['/products/']) ?>" class="s-text13 active1">
                        All
                    </a>
                </li>
                <?php foreach ($categories as $cat){
                    ?>
                    <li class="p-t-4">
                        <a href="<?= \yii\helpers\Url::to(['/products/'.$cat['slug']]) ?>" class="s-text13 active1">
                            <?= $cat['title']?>
                        </a>
                    </li>
                <?php
    ...
    if(!empty($products)){
        foreach ($products as $pr){
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
                <!-- Block2 -->
                <div class="block2">
                    <div class="block2-img <?= (!empty($pr['sale_price']))?'block2-labelsale':'block2-labelnew';?> wrap-pic-w of-hidden pos-relative">
                        <img src="<?= \yii\helpers\Url::to(['/']) ?>images/item-02.jpg" alt="IMG-PRODUCT">
                    ...
                    <div class="block2-txt p-t-20">
                        <a href="<?php echo \yii\helpers\Url::to(['/product/'.$pr['id']]) ?>" class="block2-name dis-block s-text3 p-b-5">
                           <?= $pr['title'];?>
                        </a>
